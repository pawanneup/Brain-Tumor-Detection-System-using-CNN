  ...
  return (
    <Layout>
      ...
      >
        <Card
          style={{ width: "100%", }}
          className="profile2-card"
        >
          <div style={{ display: "flex", alignItems: "center", marginBottom: "1rem" }}>
            <Avatar size={250} src={user.imageUrl}/>
          ...
          <div className="follower-count">Followers: 32</div>
        </Card>
      </div>
    </Layout>
  );
...
//     <Layout>
//       <Card
//         style={{ maxWidth: 500, margin: "auto", marginTop: "2rem" }}
//         className="card profile"
//       >
//         <div className="profile-header">
//           <Avatar size={200} src={user.imageUrl} />
//           <div className="profile-details">
//             <Title className="profile-name" size="large" level={1}>
//               {user.name}
//             </Title>
//             <Button type="primary" size="large">
//               Change Photo
