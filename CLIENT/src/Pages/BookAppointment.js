        ...
        {doctor && (
          <div>
            ...
            <Row gutter={20} className="mt-5">
              <Col>
                <img
                  src="https://img.freepik.com/free-vector/book-your-date-mobile-phone_23-2148552969.jpg?t=st=1718026688~exp=1718030288~hmac=31645f3cb91c4eaa1eb873eda62fc357b6d0bcf5885a91140d6711a1b722011d&w=740"
                  alt="Booking Image"
                  width="100%"
                  height={500}
                />
              ...
              <Col span={8} sm={24} xs={24} lg={8}>
                ...
                <div className="d-flex flex-column pt-2">
                  ...
                  <TimePicker
                    ...
                    className="mt-3"
                    onChange={(time, timeString) => {
                      console.log("value entered ", timeString);
